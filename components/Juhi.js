...
function LandingScreen({ setStep }) {
  return (
    <div className="flex flex-col items-center text-center space-y-6">
      ...
      <button
        onClick={() => setStep(2)}
        className="mt-8 px-10 py-4 bg-purple-500 hover:bg-purple-600 text-white font-bold text-xl rounded-full shadow-lg hover:shadow-2xl hover:scale-105 active:scale-95 transition-all"
      >
        LET'S GOOO &rarr;
      </button>
    </div>
...
function PartyScreen({ setStep }) {
  return (
    <div className="flex flex-col items-center text-center space-y-10">
      <h2 className="text-5xl md:text-6xl font-black text-purple-600 drop-shadow-sm">
        Time to Celebrate!
      </h2>
      ...
      <button
        onClick={() => setStep(7)}
        className="px-12 py-5 bg-purple-500 hover:bg-purple-600 text-white font-black rounded-full shadow-2xl hover:shadow-purple-500/50 transition-all hover:scale-110 active:scale-95 text-2xl animate-pulse"
      >
